<div class="modal" id="newTask" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form onsubmit="createTask(this,event)" id="taskNewForm" class="mx-auto row ">
                    <?= csrf() ?>
